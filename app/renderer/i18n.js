...
(() => {
  ...
  const LOC = {
    ...
    cmpTip: {
      it: 'Confronta con un’altra stampante',
      en: 'Compare with another printer',
      es: 'Comparar con otra impresora',
      fr: 'Comparer avec une autre imprimante',
    },
    ...
    sHistory: {
      it: 'Le stampe salvate restano qui: totali per mese e registro completo, esportabile in CSV. I dati vivono solo sul tuo computer.',
      en: 'Saved prints live here: monthly totals and the full log, exportable as CSV. Data never leaves your computer.',
      es: 'Las impresiones guardadas viven aquí: totales por mes y registro completo, exportable a CSV. Los datos no salen de tu ordenador.',
      fr: 'Les impressions enregistrées vivent ici : totaux par mois et journal complet, exportable en CSV. Les données restent sur votre ordinateur.',
    },
    histSave: {
      it: 'Salva nel registro costi',
      en: 'Save to the cost log',
      es: 'Guardar en el registro de costes',
      fr: 'Enregistrer dans le journal des coûts',
    },
    histSaveProj: {
      it: 'Salva il progetto nel registro',
      en: 'Save project to the log',
      es: 'Guardar el proyecto en el registro',
      fr: 'Enregistrer le projet dans le journal',
    },
    histSaved: { it: 'Salvato nel registro ✓', en: 'Saved to the log ✓', es: 'Guardado en el registro ✓', fr: 'Enregistré dans le journal ✓' },
    histEmpty: {
      it: 'Registro vuoto. Salva una stampa col 💾 sulla scheda del file, o tutto il progetto col pulsante qui sopra.',
      en: 'The log is empty. Save a print with 💾 on a file card, or the whole project with the button above.',
      es: 'Registro vacío. Guarda una impresión con 💾 en la tarjeta del archivo, o todo el proyecto con el botón de arriba.',
      fr: 'Journal vide. Enregistrez une impression avec 💾 sur la carte du fichier, ou tout le projet avec le bouton ci-dessus.',
    },
    ...
    sQuote: {
      it: 'Il costo reale del progetto caricato diventa un preventivo da mandare al cliente: margine, intestazione e note sono tuoi, il PDF esce pronto.',
    ...
    qContact: {
      it: 'Intestazione (indirizzo, P.IVA, contatti…)',
      en: 'Letterhead (address, VAT no., contacts…)',
      es: 'Membrete (dirección, NIF, contacto…)',
      fr: 'En-tête (adresse, n° TVA, contacts…)',
    },
    ...
    qLogoBig: {
      it: 'Logo troppo grande: massimo 2 MB.',
      en: 'Logo too large: 2 MB max.',
      es: 'Logo demasiado grande: máximo 2 MB.',
      fr: 'Logo trop lourd : 2 Mo max.',
    },
    ...
    qDetail: {
      it: 'Mostra costo di produzione e margine',
      en: 'Show production cost and margin',
      es: 'Mostrar coste de producción y margen',
      fr: 'Afficher coût de production et marge',
    },
    ...
    qEmpty: {
      it: 'Carica e slica dei file: il preventivo nasce dal loro costo reale.',
