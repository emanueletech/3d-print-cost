...
enum Loc {
    static let s: [String: [String: String]] = [
        ...
        "cmpTip": ["it":"Confronta con un'altra stampante","en":"Compare with another printer",
                   "es":"Comparar con otra impresora","fr":"Comparer avec une autre imprimante"],
        ...
        "qContact": ["it":"Intestazione (indirizzo, P.IVA, contatti…)","en":"Letterhead (address, VAT no., contacts…)",
                     "es":"Membrete (dirección, NIF, contacto…)","fr":"En-tête (adresse, n° TVA, contacts…)"],
        "qLogo": ["it":"Logo","en":"Logo","es":"Logo","fr":"Logo"],
        "qLogoPick": ["it":"Carica logo…","en":"Load logo…","es":"Cargar logo…","fr":"Charger le logo…"],
        "qLogoDel": ["it":"Rimuovi logo","en":"Remove logo","es":"Quitar logo","fr":"Retirer le logo"],
        "qLogoBig": ["it":"Logo troppo grande: massimo 2 MB.","en":"Logo too large: 2 MB max.",
                     "es":"Logo demasiado grande: máximo 2 MB.","fr":"Logo trop lourd : 2 Mo max."],
